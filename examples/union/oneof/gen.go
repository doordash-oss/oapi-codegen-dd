...
type Order struct {
	Product     *Order_Product_OneOf     `json:"product,omitempty"`
	Description *Order_Description_OneOf `json:"description,omitempty"`
	Images      []Order_Images_OneOf     `json:"images,omitempty"`
}
...
type Order_Product_OneOf_3 struct {
	Description *Order_Product_OneOf_3_Description_OneOf `json:"description,omitempty"`
}
