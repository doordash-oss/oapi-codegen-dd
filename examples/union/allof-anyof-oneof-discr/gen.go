...
type ClientAndMaybeIdentity struct {
	Entity *ClientAndMaybeIdentity_Entity_AnyOf `json:"entity,omitempty"`
...
type ClientOrID ClientOrID_OneOf

func (c ClientOrID) Validate() error {
	return schemaTypesValidate.Struct(c)
}

type ClientOrIdentityWithDiscriminator ClientOrIdentityWithDiscriminator_OneOf
