...
type ClientInterface interface {
	UploadDocument(ctx context.Context, options *UploadDocumentRequestOptions, reqEditors ...runtime.RequestEditorFn) (*UploadDocumentResponseJSON, error)
...
func (c *Client) UploadDocument(ctx context.Context, options *UploadDocumentRequestOptions, reqEditors ...runtime.RequestEditorFn) (*UploadDocumentResponseJSON, error) {
	var err error
	...
	responseParser := func(ctx context.Context, resp *runtime.Response) (*UploadDocumentResponseJSON, error) {
		bodyBytes := resp.Content
		if resp.StatusCode != 202 {
			target := new(UploadDocumentErrorResponse)
		...
		target := new(UploadDocumentResponseJSON)
