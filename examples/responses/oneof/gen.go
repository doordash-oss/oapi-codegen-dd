...
type ClientInterface interface {
	...
	ProcessPayment(ctx context.Context, options *ProcessPaymentRequestOptions, reqEditors ...runtime.RequestEditorFn) (*ProcessPaymentResponse, error)
}

// ProcessPayment Process payment operations
func (c *Client) ProcessPayment(ctx context.Context, options *ProcessPaymentRequestOptions, reqEditors ...runtime.RequestEditorFn) (*ProcessPaymentResponse, error) {
	var err error
	...
	responseParser := func(ctx context.Context, resp *runtime.Response) (*ProcessPaymentResponse, error) {
		bodyBytes := resp.Content
		if resp.StatusCode != 200 {
			return nil, runtime.NewClientAPIError(fmt.Errorf("unexpected status code: %d", resp.StatusCode),
				runtime.WithStatusCode(resp.StatusCode))
		}
		target := new(ProcessPaymentResponse)
